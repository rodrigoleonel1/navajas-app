...
const variantClasses: Record<Variant, string> = {
  primary:
    "inline-flex items-center justify-center gap-1 px-6 py-3 text-xs font-semibold tracking-wide rounded-full bg-primary text-background hover:bg-primary-low transition-colors duration-200 cursor-pointer",
  secondary:
    "inline-flex items-center gap-1 px-6 py-3 bg-foreground text-background rounded-full  text-xs font-semibold tracking-wide hover:bg-white transition-colors duration-200 cursor-pointer",
  outline:
